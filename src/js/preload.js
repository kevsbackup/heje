...
preLoad.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" height="128px" width="128px" viewBox="0 0 128 128" class="pl">
<defs>
  <linearGradient y2="1" x2="0" y1="0" x1="0" id="pl-grad">
    <stop stop-color="hsl(269,90%,55%)" offset="0%"></stop>
    <stop stop-color="hsl(284,90%,55%)" offset="100%"></stop>
  </linearGradient>
</defs>
